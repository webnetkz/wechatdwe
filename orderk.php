...
<div class="preloader">
 ...
 <div class="input-group">
 <span class="input-group-addon"><i class="fa fa-phone fa" aria-hidden="true"></i></span>
 <input type="tel" class="form-control" name="toPhone" placeholder="Номер телефона" pattern="\+7\s?[\(]{0,1}7[0-9]{2}[\)]{0,1}\s?\d{3}[-]{0,1}\d{2}[-]{0,1}\d{2}" placeholder="Номер телефона" class="inp" oninput="validatePhone(this); console.log(this.value)" oninvalid="this.setCustomValidity('Вы не верно ввели номер телефона')" onclick="this.value = '+7 ('" required/>
 </div>
 </div>
 </div>
<hr>
