...
.login-button{
 ...
 <form class="" method="post" action="../app/api/orderWechat"> 
...
<hr>
 ...
 <input type="text" class="form-control" name="obl" id="obl" placeholder="Введите область доставки"/>
 </div>
 </div>
 </div>
	 	 	  <div class="form-group">
 ...
 <div class="input-group">
 <span class="input-group-addon"><i class="fa fa-globe fa" aria-hidden="true"></i></span>
 <input type="text" class="form-control" name="toCity" id="obl" placeholder="Введите город доставки"/>
 </div>
 </div>
 </div>
 ...
 <div class="input-group">
 <span class="input-group-addon"><i class="fa fa-globe fa" aria-hidden="true"></i></span>
 <input type="text" class="form-control" name="toAdres" id="obl" placeholder="Введите адрес доставки"/>
 </div>
 </div>
 </div>
	 <hr>
 ...
 <input type="text" class="form-control" name="fromQID" id="obl" placeholder="Введите трекинг номер"/>
 </div>
 </div>
 </div>
	 	 	 	 	  <div class="form-group">
 ...
 <input type="text" class="form-control" name="toToItems" id="obl" placeholder="Введите описание вложения"/>
 </div>
 </div>
 </div>
	 	 	 	 	 	  <div class="form-group">
 ...
 <div class="input-group">
 <span class="input-group-addon"><i class="fa fa-pencil fa" aria-hidden="true"></i></span>
 <input type="text" class="form-control" name="prim" id="obl" placeholder="Введите примечание"/>
 </div>
 </div>
 </div>
	 	 	 	 	 	 	  <div class="form-group">
