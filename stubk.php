		...
		<div class="container">
          <div class="row">
               <div class="col-md-12 col-sm-12 blockW">
				   <h1 class="h2">Доставка в Казахстан</h1>
				   <h1 class="h2">ВАЖНО：</h1>
				   	<p class="ppp">1. Мы не принимаем грузы kuàidì с оплатой при получении!</p>
				   <p class="ppp">2. Оплата доставки, только при отправлении!</p>
				   <p class="ppp">3.Оплата доставки производится до 18:00 по Пекину. Отправка будет осуществляться в этот же день, если оплачиваете позже, то отправка на следующий день после оплаты！</p>
...
<tr>
  ...
  <td>199,50</td>
				   				   ...
				   				   <tr>
  <td>Если посылка превышает 5 кг, то каждый следующий килограмм будет стоить 40￥/кг.</td>
									   <td>40￥/кг </td>
</tr>
				   				   				   <tr>
  <td>Пример - вес посылки 5.6 кг - 199.50￥+40￥ = 239.50￥</td><td></td>
</tr>
</table>
</p>
