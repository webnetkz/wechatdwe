...
<section id="home">
    ...
    <div>
                   ...
                   <hr>
                <p style="text-align: left;">2 шаг:  зайдите в учетную запись wechat/DWExpress и заполните данные отправителя/получателя, трек-номер (kuaidi) посылки, отправленной к нам на склад.</p>
                    <hr>
